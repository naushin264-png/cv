...
%% ---------------------------------------------------------------- skills ----
%% Skills lead the document: a reader screening for specific instruments and
%% techniques should hit them before the narrative of the roles.
...
\begin{itemize}
  ...
  \item Built XMCD sum-rule analysis with six-source Monte Carlo error propagation, and XPEEM
        asymmetry-map pipelines (drift correction, cross-registration, domain heterogeneity
        metrics) across temperature series.
...
\entry{University of California, Davis}{Sep 2021 -- Expected Oct 2026}{Graduate Student Researcher}
\begin{itemize}
  \item Deposit multi-principal element alloy thin films by DC magnetron sputtering and
        co-sputtering (AJA Orion 8); own preventive maintenance and troubleshooting of the system,
        including regular target and gas cylinder changes, turbomolecular pump replacement, roughing
        pump servicing and oil changes, and commissioning of DC power supplies.
...
%% ------------------------------------------------------------- education ----
%% Hold both degrees together. Without this the section splits and the BUET
%% entry lands at the top of page 2 with no heading above it.
\Needspace*{9\baselineskip}
\section{Education}

\entry{University of California, Davis --- Ph.D., Materials Science and Engineering}{Sep 2021 -- Expected Oct 2026}{}
\begin{itemize}
